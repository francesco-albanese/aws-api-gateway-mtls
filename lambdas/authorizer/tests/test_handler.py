...
from src.authorizer.event_parser import extract_bearer_token, extract_serial_number
...
class TestExtractSerialNumber:
    """Tests for extract_serial_number helper."""
...
class TestHandler:
    ...
    def test_denies_when_jwt_validation_fails(
        ...
        with patch("src.authorizer.handler.validate_jwt", return_value=None):
